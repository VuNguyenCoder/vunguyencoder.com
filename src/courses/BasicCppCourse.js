...
export default function BasicCppCourse()
{
	return(
		<div className='Content'>
			...
			- Các bạn đang muốn học lập trình từ xa, không cần phải đến lớp những vẫn muốn được support trực tiếp từ giảng viên<br/><br/>
			...
			<b>3. Ưu điểm của khóa học này</b><br/>
