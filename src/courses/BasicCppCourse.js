...
export default function BasicCppCourse()
{
	return(
		<div className='Content'>
			<h2>Khóa học lập trình căn bản với C++</h2><br/>
			<i>Học phí: 399k VNĐ</i> <br/>
			<i>Giảng viên: Vũ Nguyễn Coder</i><br/>
			<br/>
			<b>1. Khóa học này sẽ phù hợp với:</b><br/>
			- Các bạn đang chuẩn bị trở thành sinh viên IT<br/>
			- Các bạn sinh viên IT đang mất gốc về căn bản<br/>
			- Các bạn đang muốn học nền tảng về lập trình để phục vụ cho công việc<br/><br/>
			
			<b>2. Tại sao chúng ta nên học C++ để xây dựng nền tảng tư duy lập trình? </b><br/>
			...
			- C++ cực kỳ mạnh mẽ, đặc biệt là tốc độ tính toán cao, nên nó thường để xây dựng nên những chương trình phức tạp như hệ điều hành, ứng dụng đồ họa (Game, xử lý ảnh,... ), phần mềm nhúng,... Vậy nên, nếu bạn có dự định trở thành lập trình viên C++ chuyên nghiệp cũng là một định hướng sáng. Ở Việt Nam, cơ hội việc làm với C++ tương đối nhiều. Còn nêu như sau này dòng đời xô đẩy bạn sang một mảng lập trình khác thì với nền tảng C++ chắc chắn cũng sẽ giúp bạn thích nghi cực nhanh với một ngôn ngữ mới<br/><br/>

			<b>3. Chính vì C++ bám sát chặt chẽ những yếu tố nền tảng nhất, nên đôi khi người học sẽ cảm thấy trừu tượng và khó hiểu. Với kinh nghiệm lâu năm của mình trong các dự án phát triển hệ thống với C++, mình hiểu được những khó khăn đó và xây dựng nên một hệ phương pháp luận để giải thích và truyền đạt lại tới các bạn. Trong khóa học này, các bạn sẽ có quyền lợi như sau:</b> <br/>
			...
			- Bạn sẽ sở hữu khóa học vô thời hạn, tức là chỉ một lần chi phí là sở hữu gói support trọn đời<br/><br/>

			<b>4. Nội dung khóa học</b><br/>
			- Nắm chắc các khái niệm căn bản trong lập trình như biến, hàm, câu điều kiện, vòng lặp, con trỏ, cấu trúc dữ liệu,v.v... Các bạn sẽ hiểu được chúng hoạt động như thế nào thông qua các ví dụ trực tiếp trên công cụ lập trình Visual Studio. <br/>
			...
			- Cuối khóa, bạn sẽ làm được một chương trình phần mềm quản lý, vận dụng tổng hợp kiến thức của toàn khóa học. Hoàn thành xong chương trình này, bạn đã có căn cơ để học sang những kiến thức chuyên sâu về các loại phần mềm cụ thể.<br/><br/>

			<b>5. Cách thức tham gia</b> <br/>
