		...
		<div className='Content'>
			...
			<Accordion defaultActiveKey="0">
				<Accordion.Item eventKey="0">
					...
					<br/>
					<b>Lưu ý:</b> Nếu bạn mong muốn xây dựng nền tảng ở một mức sâu hơn dưới tầng bộ nhớ, bạn nên học C/C++. Ngoài ra, với các bạn định hướng theo phần cứng, mạch, nhúng, game,... cũng nên chọn C/C++. Bạn có thể tham gia lớp C/C++ của mình tại <a href="/courses/cppbasic">đây</a> 
					</Accordion.Body>
				</Accordion.Item>
